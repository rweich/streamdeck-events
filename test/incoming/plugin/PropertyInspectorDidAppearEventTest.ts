...
import PropertyInspectorDidAppearEvent from '../../../src/incoming/plugin/PropertyInspectorDidAppearEvent';
...
describe('PropertyInspectorDidAppearEvent test', () => {
  it('should create the event when using the correct payload', function () {
    ...
    expect(event.event).to.equal(IncomingPluginEvents.PropertyInspectorDidAppear);
  });
