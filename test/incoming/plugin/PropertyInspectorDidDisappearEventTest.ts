...
import PropertyInspectorDidDisappearEvent from '../../../src/incoming/plugin/PropertyInspectorDidDisappearEvent';
...
describe('PropertyInspectorDidDisappearEvent test', () => {
  it('should create the event when using the correct payload', function () {
    ...
    expect(event.event).to.equal(IncomingPluginEvents.PropertyInspectorDidDisappear);
  });
